    ...
    <section class="bg-img conferences-banner">
        <div class="container">
            <div class="conferences-banner-content text-center">
                <h2 class="title">Clinical Trial Supply Conferences</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Clinical Trial Supply</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row" style="justify-content: center;">
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/CTS-6.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                                    <span class="date"><span>02-03</span> <span>May-24</span></span>
                                </div>
                            </div>
                            <div class="events-description">
                                <span class="category cts-bgcolor">Clinical Trial Supply</span>
                                <h3 class="card-title title">
                                    <a href="">6<sup>th</sup> Clinical Trial Supply Forum</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/CTS-5.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                            ...
                            <div class="events-description">
                                <span class="category cts-bgcolor">Clinical Trial Supply</span>
                                <h3 class="card-title title">
                                    <a href="">5<sup>th</sup> Clinical Trial Supply Forum</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/CTS-4.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                            ...
                            <div class="events-description">
                                <span class="category cts-bgcolor">Clinical Trial Supply</span>
                                <h3 class="card-title title">
                                    <a href="">USA Clinical Trial Supply Forum</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/CTS-3.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                            ...
                            <div class="events-description">
                                <span class="category cts-bgcolor">Clinical Trial Supply</span>
                                <h3 class="card-title title">
                                    <a href="">3<sup>rd</sup> Clinical Trial Supply Forum</a>
                                </h3>
                                <span class="card-subtitle location"><i class="fas fa-map-marker-alt"></i> <span>Kaarst, Germany</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/CTS-2.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                            ...
                            <div class="events-description">
                                <span class="category cts-bgcolor">Clinical Trial Supply</span>
                                <h3 class="card-title title">
                                    <a href="">2<sup>nd</sup> Clinical Trial Supply Forum</a>
                                </h3>
