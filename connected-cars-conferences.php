    ...
    <section class="bg-img conferences-banner">
        <div class="container">
            <div class="conferences-banner-content text-center">
                <h2 class="title">Connected Cars Conferences</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Connected Cars</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row" style="justify-content: center;">
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/DRCC-1.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                                    <span class="date"><span>13-14</span> <span>Mar-24</span></span>
                                </div>
                            </div>
                            <div class="events-description">
                                <span class="category drcc-bgcolor">Connected Cars</span>
                                <h3 class="card-title title">
                                    <a href="">3<sup>rd</sup> Digital Rrevolution in Connected Cars</a>
                                </h3>
                                <span class="card-subtitle location"><i class="fas fa-map-marker-alt"></i> Munich Marriott Hotel City West, Germany</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item past-events mb-4">
                        <div class="card event-cards">
                            <div class="card-img">
                                <a href=""><img class="img-fluid card-img-top" src="images/conferences/DRCC-2.webp" alt="World BI Events" /></a>
                                <div class="event-date">
                                    <span class="date"><span>22-23</span> <span>Mar-23</span></span>
                                </div>
                            </div>
                            <div class="events-description">
                                <span class="category drcc-bgcolor">Connected Cars</span>
                                <h3 class="card-title title">
                                    <a href="">2<sup>nd</sup> Digital Rrevolution in Connected Cars</a>
                                </h3>
                                <span class="card-subtitle location"><i class="fas fa-map-marker-alt"></i> Hilton Munich City, Germany</span>
                            </div>
                        </div>
                    </div>
